...
export const CloneProduct = () => {
  // Chú ý: Ở màn clone, chúng ta dùng component Create nhưng load data thông qua action="clone" nếu Refine tự nhận, hoặc như code cũ bạn đang viết.
  ...
  return (
    <Create 
      title={<Title level={3} className="pd-m-0 pd-text-ocean pd-font-bold">Nhân bản sản phẩm</Title>}
      footerButtons={
    ...
    >
      <Form {...formProps} layout="vertical">
        <Card 
            ...
            title={<Space><AppstoreAddOutlined className="pd-text-ocean" /><Text strong className="pd-text-ocean pd-font-16">Thông tin chi tiết sản phẩm</Text></Space>}
        >
          <Row gutter={32}>
            <Col xs={24} lg={12}>
