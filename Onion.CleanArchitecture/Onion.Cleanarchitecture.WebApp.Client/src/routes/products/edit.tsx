...
export const EditProduct = () => {
  ...
  return (
    <>
      <style>{STYLES}</style>
      <Edit 
        title={<Title level={3} style={{ margin: 0, color: '#476481', fontWeight: 700 }}>Chỉnh sửa Sản phẩm</Title>}
        ...
        <Form {...formProps} layout="vertical" className="pearl-form">
          ...
          <div className="pearl-card">
            <div className="pearl-card-header">
              <div style={{ background: '#f0fdfa', color: '#0d9488', width: 36, height: 36, borderRadius: 8, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 18 }}><EditOutlined /></div>
